# Replace lines 969 to 995 (indices 968 to 994) in app.js
lines = open('app.js', 'r', encoding='utf-8').readlines()

new_block = """      if (videoPlayer.canPlayType('application/vnd.apple.mpegurl')) {
...
lines[968:995] = [new_block + "\n"]
open('app.js', 'w', encoding='utf-8').writelines(lines)
print('Replaced HLS block')
